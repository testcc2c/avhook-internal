...
namespace signatures {
	...
	const DWORD dwForceAttack = 0x31D3714;
	const DWORD dwForceAttack2 = 0x31D3720;
	const DWORD dwForceBackward = 0x31D375C;
	const DWORD dwForceForward = 0x31D3768;
	const DWORD dwForceJump = 0x524CFDC;
	const DWORD dwForceLeft = 0x31D3780;
	const DWORD dwForceRight = 0x31D3774;
	...
	const DWORD dwPlayerResource = 0x31D1AA0;
	const DWORD dwRadarBase = 0x51D7F64;
	const DWORD dwSensitivity = 0xD8FCC4;
	const DWORD dwSensitivityPtr = 0xD8FC98;
	const DWORD dwSetClanTag = 0x8A1B0;
	const DWORD dwViewMatrix = 0x4D94B04;
	const DWORD dwWeaponTable = 0x51F5270;
	...
	const DWORD m_pitchClassPtr = 0x51D8200;
	const DWORD m_yawClassPtr = 0xD8FA88;
	const DWORD model_ambient_min = 0x58C064;
	const DWORD set_abs_angles = 0x1E0AC0;
	const DWORD set_abs_origin = 0x1E0900;
} // namespace signatures