...
namespace signatures {
	...
	constexpr DWORD dwEntityList = 0x4DA3F5C;
	constexpr DWORD dwForceAttack = 0x31D54B4;
	constexpr DWORD dwForceAttack2 = 0x31D54C0;
	constexpr DWORD dwForceBackward = 0x31D5508;
	constexpr DWORD dwForceForward = 0x31D5514;
	constexpr DWORD dwForceJump = 0x524DEBC;
	constexpr DWORD dwForceLeft = 0x31D5490;
	constexpr DWORD dwForceRight = 0x31D5484;
	constexpr DWORD dwGameDir = 0x62D7F8;
	constexpr DWORD dwGameRulesProxy = 0x52C119C;
	constexpr DWORD dwGetAllClasses = 0xDB3F9C;
	constexpr DWORD dwGlobalVars = 0x58ECE8;
	constexpr DWORD dwGlowObjectManager = 0x52EC550;
	constexpr DWORD dwInput = 0x51F5540;
	...
	constexpr DWORD dwPlayerResource = 0x31D3810;
	constexpr DWORD dwRadarBase = 0x51D8CD4;
	constexpr DWORD dwSensitivity = 0xD91D0C;
	constexpr DWORD dwSensitivityPtr = 0xD91CE0;
	constexpr DWORD dwSetClanTag = 0x8A1B0;
	constexpr DWORD dwViewMatrix = 0x4D95874;
	constexpr DWORD dwWeaponTable = 0x51F6000;
	...
	constexpr DWORD find_hud_element = 0x2843E320;
	...
	constexpr DWORD m_pitchClassPtr = 0x51D8F70;
