...
namespace signatures {
	...
	constexpr DWORD dwEntityList = 0x4DA2F54;
	constexpr DWORD dwForceAttack = 0x31D44E4;
	constexpr DWORD dwForceAttack2 = 0x31D44F0;
	constexpr DWORD dwForceBackward = 0x31D449C;
	constexpr DWORD dwForceForward = 0x31D44A8;
	constexpr DWORD dwForceJump = 0x524CEB4;
	constexpr DWORD dwForceLeft = 0x31D44C0;
	constexpr DWORD dwForceRight = 0x31D44B4;
	constexpr DWORD dwGameDir = 0x62D7F8;
	constexpr DWORD dwGameRulesProxy = 0x52C019C;
	constexpr DWORD dwGetAllClasses = 0xDB2F9C;
	constexpr DWORD dwGlobalVars = 0x58ECE8;
	constexpr DWORD dwGlowObjectManager = 0x52EB548;
	constexpr DWORD dwInput = 0x51F4538;
	...
	constexpr DWORD dwPlayerResource = 0x31D2810;
	constexpr DWORD dwRadarBase = 0x51D7CCC;
	constexpr DWORD dwSensitivity = 0xD90D0C;
	constexpr DWORD dwSensitivityPtr = 0xD90CE0;
	constexpr DWORD dwSetClanTag = 0x8A1A0;
	constexpr DWORD dwViewMatrix = 0x4D94854;
	constexpr DWORD dwWeaponTable = 0x51F4FF8;
	...
	constexpr DWORD find_hud_element = 0x52B0E320;
	...
	constexpr DWORD m_pitchClassPtr = 0x51D7F68;
