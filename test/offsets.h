...
namespace signatures {
	...
	constexpr DWORD dwEntityList = 0x4DA2F34;
	constexpr DWORD dwForceAttack = 0x31D4470;
	constexpr DWORD dwForceAttack2 = 0x31D447C;
	constexpr DWORD dwForceBackward = 0x31D44AC;
	constexpr DWORD dwForceForward = 0x31D4488;
	constexpr DWORD dwForceJump = 0x524CE94;
	constexpr DWORD dwForceLeft = 0x31D44A0;
	constexpr DWORD dwForceRight = 0x31D44C4;
	constexpr DWORD dwGameDir = 0x62D7F8;
	constexpr DWORD dwGameRulesProxy = 0x52C017C;
	constexpr DWORD dwGetAllClasses = 0xDB2F9C;
	constexpr DWORD dwGlobalVars = 0x58ECE8;
	constexpr DWORD dwGlowObjectManager = 0x52EB550;
	constexpr DWORD dwInput = 0x51F4518;
	constexpr DWORD dwInterfaceLinkList = 0x946064;
	constexpr DWORD dwLocalPlayer = 0xD8B2CC;
	constexpr DWORD dwMouseEnable = 0xD90E70;
	constexpr DWORD dwMouseEnablePtr = 0xD90E40;
	constexpr DWORD dwPlayerResource = 0x31D27F0;
	constexpr DWORD dwRadarBase = 0x51D7CAC;
	constexpr DWORD dwSensitivity = 0xD90D0C;
	constexpr DWORD dwSensitivityPtr = 0xD90CE0;
	constexpr DWORD dwSetClanTag = 0x8A1A0;
	constexpr DWORD dwViewMatrix = 0x4D94834;
	constexpr DWORD dwWeaponTable = 0x51F4FD8;
	...
	constexpr DWORD find_hud_element = 0x2CAEE320;
	...
	constexpr DWORD m_pitchClassPtr = 0x51D7F48;
