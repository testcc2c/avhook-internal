...
namespace signatures {
	...
	const DWORD dwEntityList = 0x4DA3F5C;
	const DWORD dwForceAttack = 0x31D54B4;
	const DWORD dwForceAttack2 = 0x31D54C0;
	const DWORD dwForceBackward = 0x31D5508;
	const DWORD dwForceForward = 0x31D5514;
	const DWORD dwForceJump = 0x524DEBC;
	const DWORD dwForceLeft = 0x31D5490;
	const DWORD dwForceRight = 0x31D5484;
	const DWORD dwGameDir = 0x6277F8;
	const DWORD dwGameRulesProxy = 0x52C119C;
	const DWORD dwGetAllClasses = 0xDB3F9C;
	const DWORD dwGlobalVars = 0x588CE8;
	const DWORD dwGlowObjectManager = 0x52EC550;
	const DWORD dwInput = 0x51F5540;
	const DWORD dwInterfaceLinkList = 0x946B44;
	const DWORD dwLocalPlayer = 0xD8C2CC;
	const DWORD dwMouseEnable = 0xD91E70;
	const DWORD dwMouseEnablePtr = 0xD91E40;
	const DWORD dwPlayerResource = 0x31D3810;
	const DWORD dwRadarBase = 0x51D8CD4;
	const DWORD dwSensitivity = 0xD91D0C;
	const DWORD dwSensitivityPtr = 0xD91CE0;
	const DWORD dwSetClanTag = 0x8A1B0;
	const DWORD dwViewMatrix = 0x4D95874;
	const DWORD dwWeaponTable = 0x51F6000;
	const DWORD dwWeaponTableIndex = 0x325C;
	const DWORD dwYawPtr = 0xD91AD0;
	const DWORD dwZoomSensitivityRatioPtr = 0xD96D70;
	const DWORD dwbSendPackets = 0xD749A;
	const DWORD dwppDirect3DDevice9 = 0xA7050;
	const DWORD find_hud_element = 0x513DE320;
	const DWORD force_update_spectator_glow = 0x3AD962;
	const DWORD interface_engine_cvar = 0x3E9EC;
	const DWORD is_c4_owner = 0x3BA430;
	const DWORD m_bDormant = 0xED;
	const DWORD m_flSpawnTime = 0xA370;
	const DWORD m_pStudioHdr = 0x294C;
	const DWORD m_pitchClassPtr = 0x51D8F70;
	const DWORD m_yawClassPtr = 0xD91AD0;
