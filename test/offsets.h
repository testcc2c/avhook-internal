...
namespace signatures {
	...
	constexpr DWORD dwEntityList = 0x4DA3FA4;
	constexpr DWORD dwForceAttack = 0x31D5534;
	constexpr DWORD dwForceAttack2 = 0x31D5540;
	constexpr DWORD dwForceBackward = 0x31D54EC;
	constexpr DWORD dwForceForward = 0x31D54F8;
	constexpr DWORD dwForceJump = 0x524DF04;
	constexpr DWORD dwForceLeft = 0x31D5510;
	constexpr DWORD dwForceRight = 0x31D5504;
	constexpr DWORD dwGameDir = 0x62D7F8;
	constexpr DWORD dwGameRulesProxy = 0x52C11EC;
	constexpr DWORD dwGetAllClasses = 0xDB3F9C;
	constexpr DWORD dwGlobalVars = 0x58ECE8;
	constexpr DWORD dwGlowObjectManager = 0x52EC598;
	constexpr DWORD dwInput = 0x51F5588;
	...
	constexpr DWORD dwPlayerResource = 0x31D3860;
	constexpr DWORD dwRadarBase = 0x51D8D1C;
	constexpr DWORD dwSensitivity = 0xD91D0C;
	constexpr DWORD dwSensitivityPtr = 0xD91CE0;
	constexpr DWORD dwSetClanTag = 0x8A1A0;
	constexpr DWORD dwViewMatrix = 0x4D958A4;
	constexpr DWORD dwWeaponTable = 0x51F6048;
	...
	constexpr DWORD find_hud_element = 0x285CE320;
	...
	constexpr DWORD m_pitchClassPtr = 0x51D8FB8;
