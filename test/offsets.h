...
namespace signatures {
	...
	const DWORD dwEntityList = 0x4DA215C;
	const DWORD dwForceAttack = 0x31D2690;
	const DWORD dwForceAttack2 = 0x31D269C;
	const DWORD dwForceBackward = 0x31D26CC;
	const DWORD dwForceForward = 0x31D26A8;
	const DWORD dwForceJump = 0x524BF4C;
	const DWORD dwForceLeft = 0x31D26C0;
	const DWORD dwForceRight = 0x31D26E4;
	const DWORD dwGameDir = 0x627780;
	const DWORD dwGameRulesProxy = 0x52BF23C;
	const DWORD dwGetAllClasses = 0xDB0FC4;
	const DWORD dwGlobalVars = 0x588CF0;
	const DWORD dwGlowObjectManager = 0x52EA5D0;
	const DWORD dwInput = 0x51F3720;
	const DWORD dwInterfaceLinkList = 0x945514;
	const DWORD dwLocalPlayer = 0xD892CC;
	const DWORD dwMouseEnable = 0xD8EE18;
	const DWORD dwMouseEnablePtr = 0xD8EDE8;
	const DWORD dwPlayerResource = 0x31D0A10;
	const DWORD dwRadarBase = 0x51D6ED4;
	const DWORD dwSensitivity = 0xD8ECB4;
	const DWORD dwSensitivityPtr = 0xD8EC88;
	const DWORD dwSetClanTag = 0x8A1B0;
	const DWORD dwViewMatrix = 0x4D93A74;
	const DWORD dwWeaponTable = 0x51F41E0;
	...
	const DWORD find_hud_element = 0x5383F980;
	const DWORD force_update_spectator_glow = 0x3AFECA;
	const DWORD interface_engine_cvar = 0x3E9EC;
	const DWORD is_c4_owner = 0x3BCB10;
	const DWORD m_bDormant = 0xED;
	const DWORD m_flSpawnTime = 0xA370;
	const DWORD m_pStudioHdr = 0x294C;
	const DWORD m_pitchClassPtr = 0x51D7170;
	const DWORD m_yawClassPtr = 0xD8EA78;
	const DWORD model_ambient_min = 0x58C064;
