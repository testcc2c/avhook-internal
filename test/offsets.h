...
namespace signatures {
	...
	constexpr DWORD dwGetAllClasses = 0xDB2FAC;
	constexpr DWORD dwGlobalVars = 0x58ECE8;
	constexpr DWORD dwGlowObjectManager = 0x52EB518;
	constexpr DWORD dwInput = 0x51F4508;
	constexpr DWORD dwInterfaceLinkList = 0x946254;
	constexpr DWORD dwLocalPlayer = 0xD8B2DC;
	constexpr DWORD dwMouseEnable = 0xD90E80;
	constexpr DWORD dwMouseEnablePtr = 0xD90E50;
	constexpr DWORD dwPlayerResource = 0x31D27E0;
	constexpr DWORD dwRadarBase = 0x51D7C9C;
	constexpr DWORD dwSensitivity = 0xD90D1C;
	constexpr DWORD dwSensitivityPtr = 0xD90CF0;
	...
	constexpr DWORD dwYawPtr = 0xD90AE0;
	constexpr DWORD dwZoomSensitivityRatioPtr = 0xD95D80;
	constexpr DWORD dwbSendPackets = 0xD745A;
	constexpr DWORD dwppDirect3DDevice9 = 0xA7050;
	constexpr DWORD find_hud_element = 0x50A7E320;
	...
	constexpr DWORD m_yawClassPtr = 0xD90AE0;
