...
namespace signatures {
	...
	constexpr DWORD dwEntityList = 0x4DA3F44;
	constexpr DWORD dwForceAttack = 0x31D54A4;
	constexpr DWORD dwForceAttack2 = 0x31D54B0;
	constexpr DWORD dwForceBackward = 0x31D54F8;
	constexpr DWORD dwForceForward = 0x31D5504;
	constexpr DWORD dwForceJump = 0x524DEA4;
	constexpr DWORD dwForceLeft = 0x31D5480;
	constexpr DWORD dwForceRight = 0x31D5474;
	constexpr DWORD dwGameDir = 0x62D7F8;
	constexpr DWORD dwGameRulesProxy = 0x52C118C;
	constexpr DWORD dwGetAllClasses = 0xDB3F9C;
	constexpr DWORD dwGlobalVars = 0x58ECE8;
	constexpr DWORD dwGlowObjectManager = 0x52EC558;
	constexpr DWORD dwInput = 0x51F5528;
	constexpr DWORD dwInterfaceLinkList = 0x946B44;
	constexpr DWORD dwLocalPlayer = 0xD8C2CC;
	constexpr DWORD dwMouseEnable = 0xD91E70;
	constexpr DWORD dwMouseEnablePtr = 0xD91E40;
	constexpr DWORD dwPlayerResource = 0x31D3800;
	constexpr DWORD dwRadarBase = 0x51D8CBC;
	constexpr DWORD dwSensitivity = 0xD91D0C;
	constexpr DWORD dwSensitivityPtr = 0xD91CE0;
	constexpr DWORD dwSetClanTag = 0x8A1B0;
	constexpr DWORD dwViewMatrix = 0x4D95844;
	constexpr DWORD dwWeaponTable = 0x51F5FE8;
	constexpr DWORD dwWeaponTableIndex = 0x325C;
	constexpr DWORD dwYawPtr = 0xD91AD0;
	constexpr DWORD dwZoomSensitivityRatioPtr = 0xD96D70;
	constexpr DWORD dwbSendPackets = 0xD749A;
	constexpr DWORD dwppDirect3DDevice9 = 0xA7050;
	constexpr DWORD find_hud_element = 0x2653E320;
	...
	constexpr DWORD m_pitchClassPtr = 0x51D8F58;
	constexpr DWORD m_yawClassPtr = 0xD91AD0;
